...
async function fetchOverlappingJobs(supabase, userId, windowStartMs, windowEndMs) {
  // Conservative: pull any active job in the window. Cancelled / no-show /
  // archived don't block new bookings.
  ...
  const { data, error } = await supabase
    ...
    .not('status', 'in', '(cancelled,canceled,no-show,no_show,archived,lost)');
