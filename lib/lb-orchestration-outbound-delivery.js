...
//   2. reject if |now - X-SF-Timestamp| > 300s (window catches both
//      clock skew and replay attempts with stale timestamps)
...
function buildCanonicalSigningString(timestamp, body) {
  if (typeof timestamp !== 'string' || !timestamp) {
    throw new Error('buildCanonicalSigningString: timestamp (ISO 8601 string) required');
  }
